...
const getAllProducts = async (req, res, next) => {
    try {
      ...
      const products = await Product.find(query).populate("categoryId").sort(sortOption).skip(skip).limit(limit).lean() // Use lean() for better performance when you don't need Mongoose document methods
